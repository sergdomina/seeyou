          ...
          <FAQdiv>
            <FAQul>
              ...
              <FAQli>
                ...
                <Answer>Your conferences are stored on your personal Youtube Studios  account, ensuring you benefit from all the safety features built into YouTube</Answer>
              </FAQli>
              <FAQli>
                <Questions>Is recording and storing conferences legal?</Questions>
                <Answer>SEEYOU is EU-based. According to GDPR, you may only record and store conferences for personal use. Please consult your applicable laws and regulations if recording and storing conferences outside of the EU/EEA</Answer>
              </FAQli>
              <FAQli>
                <Questions>Can I record when using SEEYOU on my mobile phone?</Questions>
                <Answer>No, limitations to the operating systems on iOS and Android prevents recordings on mobile phones. So, for now, this is a desktop feature only</Answer>
              </FAQli>
              <FAQli>
                <Questions>Does the Selfie Loop™ work on my mobile phone?</Questions>
                <Answer>No, the same problem as with recordings. So, for now, this is a desktop feature only</Answer>
              </FAQli>
              <FAQli>
                <Questions>How does the hyper-link on the sticky notes work?</Questions>
                <Answer>Simple, if you open SEEYOU and click on any note taken during a conference you have stored, the conference opens where you started taking the note. Kind of cool when preparing for an exam, a meeting, or whatever</Answer>
              </FAQli>
              <FAQli>
              ...
              <FAQli>
                ...
                <Answer>Yes, they are. SEEYOU's chat, video, and voice calls are end-to-end encrypted, meaning they're genuinely private. SEEYOU cannot read the content nor see with whom you are communicating. Nor can anyone else</Answer>
                <Answer>Unlike many other providers, this holds for group chats too. The encryption key is personal and managed by your mobile phone, and logs are not centrally stored by SEEYOU but are yours alone</Answer>
              </FAQli>
              <FAQli>
              ...
              <FAQli>
                ...
                <Answer>Because your mobile phone store your personal end-to-end encryption key, making your communication truly private</Answer>
              </FAQli>
              <FAQli>
                <Questions>How do I download SEEYOU?</Questions>
                <Answer>On the desktop, you download it either from www.seeyou.eu or from a link you either receive from a friend or copy from social media. On mobile, you download SEEYOU from the App Store or Google Play</Answer>
              </FAQli>
              <FAQli>
                <Questions>How do I download SEEYOU?</Questions>
                <Answer>On the desktop, you download it either from www.seeyou.eu or from a link you either receive from a friend or copy from social media. On mobile, you download SEEYOU from the App Store or Google Play</Answer>
              ...
              <FAQli>
                ...
                <Answer>SEEYOU will be available for limited release in version 1.0.1 in the first week of May 2022. Open release, including SEEYOU for Chromebook and Linux, is on August 1st, 2022</Answer>
              </FAQli>
              <FAQli>
                ...
                <Answer>Yes, we are, we want to create a truly equitable global community. And giving back part of the company to our users seems the right thing to do, so that is what we are doing</Answer>
              </FAQli>
              <FAQli>
                <Questions>Why are the shares given as equity tokens?</Questions>
                <Answer>Equity tokens are an easy way for users to earn fractional shares, and they allow users to move their holdings from SEEYOU to their own private cryptocurrency wallets in the form of ECR-20 based SEUs</Answer>
              </FAQli>
              <FAQli>
                <Questions>When will the SEUs and common shares be listed?</Questions>
                <Answer>Both are planned listed on reputable exchanges in the fall of 2022</Answer>
              </FAQli>
              <FAQli>
              ...
              <FAQli>
                ...
                <Answer>Yes, we are. If you find that your values align with ours and you love what you do, we may be the place for you</Answer>
              </FAQli>
              <FAQli>
